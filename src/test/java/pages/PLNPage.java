...
public class PLNPage {
    ...
    public PLNPage(AndroidDriver<MobileElement> driver){
        this.driver = driver;
        PageFactory.initElements(new AppiumFieldDecorator(driver), this);
    }

    @AndroidFindBy(id = "com.ezee.main:id/editTextID")
    private MobileElement etPLNNumber;
    ...
    public void clickPLN(AndroidDriver<MobileElement> driver){
        TouchAction touchAction = new TouchAction(driver);
        touchAction.press(PointOption.point(528, 1319))
                .release()
                .perform();
    }

    public void waitPLN(AndroidDriver<MobileElement> driver){
        WebDriverWait wait = new WebDriverWait(driver, 20);
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("com.ezee.main:id/editTextID")));
    }
    public void setPLNNumber(String plnNumber){
        etPLNNumber.sendKeys(plnNumber);
    }
    public void clickEnter(){
        ((AndroidDriver)driver).pressKey(new KeyEvent(AndroidKey.ENTER));
    }
    public void clickBuy(AndroidDriver<MobileElement> driver){
        TouchAction touchAction = new TouchAction(driver);
        touchAction.press(PointOption.point(922, 1331))
                .release()
                .perform();
    }
    public void waitProgress(AndroidDriver<MobileElement> driver){
        WebDriverWait wait = new WebDriverWait(driver, 50);
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("com.ezee.main:id/textViewName")));
    }
